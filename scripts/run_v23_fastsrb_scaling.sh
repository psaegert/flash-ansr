...
# Runs every experiment defined in configs/evaluation/scaling/v23.0-20M_fastsrb.yaml sequentially.
# Extra CLI arguments are forwarded to `flash_ansr evaluate-run` so you can override limits,
# disable resume, etc. Example:
#   ./scripts/run_v23_fastsrb_scaling.sh --limit 512 --no-resume
...
CONFIG_FILE="${ROOT_DIR}/configs/evaluation/scaling/v23.0-20M_fastsrb.yaml"
